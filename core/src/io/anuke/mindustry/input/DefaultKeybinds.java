...
public class DefaultKeybinds{
    ...
    public static void load(){
        ...
        for(String section : sections){
            ...
            "snekMode", Input.CONTROL_LEFT,
            "storeQue", Input.F1,
            "recallQue", Input.F2,
            "copyMode", Input.F3,
            "pasteMode", Input.F4,
            "quickPaste", Input.F5,
            "toggleSortQueue", Input.F6,
            "reverseQueue", Input.F7,
            "sortQueue", Input.F8,
            "openPastaMenu", Input.V,
            "rotatePatternLeft", Input.Q,
            "rotatePatternRight", Input.E,
            "multipaste", Input.SHIFT_LEFT,
